...
This addon integrates Amazon Nova Sonic speech-to-speech functionality into the ASTRA.ai framework via a WebSocket connection.

## Overview

Nova Sonic is Amazon's audio-to-audio generative AI model that enables direct speech-to-speech communication. This addon replaces the traditional ASR (Automatic Speech Recognition) + TTS (Text-to-Speech) pipeline with a single integrated solution. It:
